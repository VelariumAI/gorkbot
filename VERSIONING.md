...
|--------------|---------|-------|
| **Internal** | 5.3.0 | Latest development version |
| **Public** | 1.2.0-beta | First public-facing beta release |
| **SENSE** | 1.9.0 | On independent track |
| **SRE** | 1.0.0 | On independent track |
| **XSKILL** | 1.0.0 | On independent track |

### Rationale for 1.2.0-beta

- **Internal 5.3.0 → Public 1.2.0**:
  - Major=1: First public generation ensures clear versioning boundary between dev and public
  - Minor=2: Reflects deep feature maturity accumulated through v5.x iterations
  - Build=0: First build of this release
  - Status=beta: Feature-complete, architectural stability high, production-use viable for advanced users
